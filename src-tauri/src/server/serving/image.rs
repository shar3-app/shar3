    ...
    let mut html = String::from("
        ...
        <head>
            ...
            <style>
                ...
                #download { text-align: center; background-color: #7f5af0; transition: background 150ms; border-radius: .35rem; cursor: pointer; margin-right: .5rem; padding: .75rem; display: flex; justify-content: center; align-items: center; font-size: .75rem; font-weight: bold; color: white; font-family: sans-serif; text-decoration: none; }
